        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <section>
            ...
            <p className="text-xs text-[var(--text-secondary)] mb-3">
              Set your Anthropic API key (required), an optional custom base URL, and the
              model id. All three apply to Builtin sessions.
            </p>
                    ...
                    {expanded && (
                      <div className="px-4 pb-4 space-y-3 border-t border-[var(--border-color)]">
                        <p className="text-[10px] text-[var(--text-secondary)] pt-3">
                          API Key is required. Base URL and Model are optional overrides.
                        </p>
                        {fields.map(({ key, label: fieldLabel, secret }) => (
                          <div key={key}>
                            ...
                            <input
                              ...
                              placeholder={fieldPlaceholder[key] ?? `$${key}`}
